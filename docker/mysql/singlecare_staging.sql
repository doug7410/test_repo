...
# Generation Time: 2019-06-17 18:46:29 +0000
# ************************************************************
...
# Dump of table singlecare_staging
# ------------------------------------------------------------

DROP TABLE IF EXISTS `singlecare_staging`;

CREATE TABLE `singlecare_staging` (
  ...
  `singlecare_name` varchar(200) DEFAULT NULL,
  `singlecare_type` varchar(200) DEFAULT NULL,
  `singlecare_form` varchar(50) DEFAULT NULL,
  `singlecare_dosage` varchar(50) DEFAULT NULL,
  `singlecare_qty` float DEFAULT NULL,
  `singlecare_gb` varchar(180) DEFAULT NULL,
  ...
  `singlecare_group` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
